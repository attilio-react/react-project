...
describe('Getting movies based on genres', () => {
      ...
      it('One genre should return a result', (done) => {
          const RESPONSE = {"data":[{"id":1,"title":"Title","tagline":"Tagline","vote_average":6.1,"vote_count":1195,"release_date":"2018-02-07","poster_path":"http://path/to/poster.jpg","overview":"OVERVIEW","budget":1,"revenue":2,"genres":["Drama"],"runtime":3}],"total":1,"offset":0,"limit":10}
