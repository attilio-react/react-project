...
describe('Actions', () => {
  ...
  it('Should be able to get movie details', (done) => {
    const 
        component = mount(<App />),
        RESPONSE1 = {"id":1,"title":"Title","tagline":"Tagline","vote_average":6.1,"vote_count":1195,"release_date":"2018-02-07","poster_path":"http://path/to/poster.jpg","overview":"OVERVIEW","budget":1,"revenue":2,"genres":["Drama"],"runtime":3},
        RESPONSE2 = {"data":[{"id":3,"title":"Title3","tagline":"Tagline","vote_average":6.2,"vote_count":1197,"release_date":"2018-02-09","poster_path":"http://path/to/poster3.jpg","overview":"OVERVIEW","budget":1,"revenue":2,"genres":["Drama"],"runtime":3}, {"id":4,"title":"Title4","tagline":"Tagline4","vote_average":6.0,"vote_count":1193,"release_date":"2018-02-18","poster_path":"http://path/to/poster4.jpg","overview":"OVERVIEW4","budget":2,"revenue":3,"genres":["Thriller"],"runtime":4}],"total":2,"offset":0,"limit":10}

    fetch.mockResponses([JSON.stringify(RESPONSE1), { status: 200 }], [JSON.stringify(RESPONSE2), { status: 200 }])

    component.setState({screen: consts.DETAIL_SCREEN, selectedMovie: {}}, () => {
        component.instance().fetchMovieDetails(1, () => {
            component.update()
            expect(component.find(ResultItem).length).toBe(2);
            expect(component.find(MovieData).length).toBe(1);
            done()
